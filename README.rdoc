...
/ Need to make the buttons linkable 
...
/ Ask if a has_one connection will always have the same id as the parent. If so, won't need to do the nested routes for common apps and videos
