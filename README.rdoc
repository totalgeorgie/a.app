...
- If/then statement on home page 
...
Make an edit view for each application
Make each application deletable

Make sure only the correct user can see their own application 
